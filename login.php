...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
	   ...
	   <style type="text/css">
		   	...
		   	body {
				background-image: url(assets/img/kop.jpg);
				background-size: 100%;
			}
    ...
    <div class="container">
        <div class="row text-center ">
            <div class="col-md-12">
				<br /><br /><br>
						...
						<i style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 30px; color:white; ">
						LOGIN
						</i><br><br>
        ...
        <div class="row ">
        	<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
				...
				<center>
				<img src="assets/img/logo.jpeg" width="50px">
						...
						AMBIRU CAFE
                        	...
                        	<div class="panel-body">
                           		...
                           		<form role="form" action="" method="post"><br>
                                    ...
                                    <input class="btn btn-primary" type="submit" name="login" value="Login Now"><hr>
